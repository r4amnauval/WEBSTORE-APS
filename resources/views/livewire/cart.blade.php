                    ...
                    @forelse ($items as $item)
                        <div class="flex items-center gap-5 pb-5 border-b border-gray-200">
                            ...
                            <div class="flex items-center">
                                <div class="py-5">
                                    <h3 class="text-lg font-bold text-gray-800 dark:text-gray-800">
                                        {{ $item->product()->name }}
                                    </h3>
            ...
            <div class="md:col-span-3">
                ...
                <div class="grid gap-5">
                    ...
                    <ul class="flex flex-col mt-3">
                        <li
                            class="inline-flex items-center px-4 py-3 -mt-px text-sm text-gray-800 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:border-neutral-700 dark:text-gray-800">
