<!-- ========== HEADER ========== -->
<header
    class="z-50 flex flex-wrap w-full bg-white border-b border-gray-100 dark:bg-white dark:border-neutral-100 md:justify-start md:flex-nowrap">
    <nav
        class="relative max-w-[85rem] w-full md:flex md:items-center md:justify-between md:gap-3 mx-auto px-4 sm:px-6 lg:px-8 py-2 dark:bg-white">
        <!-- Logo w/ Collapse Button -->
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-bold text-black focus:outline-hidden focus:opacity-80 dark:text-black"
                href="{{ url('/') }}" aria-label="Brand">{{ config('app.name') }}</a>

            <!-- Collapse Button -->
            <div class="md:hidden">
                <button type="button"
                    class="relative flex items-center justify-center text-sm font-semibold text-gray-800 border border-gray-200 rounded-lg hs-collapse-toggle size-9 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-black dark:border-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
        ...
        <div id="hs-header-classic"
            ...
            <div
                ...
                <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                    ...
                    <a class="flex items-center p-2 text-sm text-gray-800 hover:text-gray-500 focus:outline-hidden focus:text-gray-500 dark:text-neutral-800 dark:hover:text-black dark:focus:text-neutral-500"
