<!-- ========== FOOTER ========== -->
<footer class="w-full mt-auto bg-gray-900 dark:bg-gray-900">
    <div class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-3">
            ...
            <div class="col-span-1">
                ...
                <div class="grid mt-3 space-y-3">
                    <p><a class="inline-flex text-gray-300 gap-x-2 hover:text-gray-200 focus:outline-hidden focus:text-gray-200 dark:text-neutral-200 dark:hover:text-white dark:focus:text-neutral-200"
                            href="{{ route('page') }}">Term & Conditions</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 focus:outline-hidden focus:text-gray-200 dark:text-neutral-200 dark:hover:text-white dark:focus:text-neutral-200"
        ...
        <div class="flex justify-center mt-5 sm:mt-12 gap-y-2 sm:gap-y-0">
            <p class="text-sm text-gray-400 dark:text-neutral-200">
